...
from app.services.SDGFilteringService import get_goals
from app.services.SDGOutputFormatterService import sdg_formatter_goals

from app.services.SDGFilteringService import SDGFilteringException

class SDGGoalsResource(Resource):

    def get(self) -> Dict[str, Any]:
        """
        Get the goals and their code available in the API
        ---
        tags:
        ...
        try:
            return {
                    "message" : "Success",
                    "status" : 200,
                    "data" : sdg_formatter_goals(get_goals())
                }, 200
        except OSError as e:
